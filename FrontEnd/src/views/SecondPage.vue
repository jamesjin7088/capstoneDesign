    ...
    async uploadImage() {
        if (this.selectedFile) {
          ...
          try {
            ...
            const response = await fetch('http://192.168.4.14:5000/upload', {
                method: 'POST',
